...
function NewsLetter() {
  return (
    <div className="bg-white flex flex-col px-[min(15%,10rem)] md:px-[min(20%,38rem)] py-14 gap-8 items-center justify-center">
        ...
        <button type="submit" className="text-white bg-ngv-blue hover:bg-[#0202cc] focus:ring-4 focus:outline-none focus:ring-blue-600 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center">
            Sign up
        </button>
        </form>
